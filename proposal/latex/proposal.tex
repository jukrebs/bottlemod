...
\title{Master Thesis Proposal: Storage-/I/O-Aware Extension of BottleMod for Modeling I/O-Intensive Workloads}
\author{\textbf{Student:} <Your Name> \\ \textbf{Supervisor:} <Supervisor Name> \\ \textbf{Institution:} <University / Chair>}
\date{\today}
...
\subsection{Model Extension (Storage-/I/O-Aware BottleMod)}
